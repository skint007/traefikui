...
import { Route, ShieldOff } from "lucide-react";
    ...
    return (
      <Card>
        <CardHeader className="text-center">
          ...
          <CardDescription>
            New account registration is currently disabled. Contact an
  ...
  return (
    <Card>
      <CardHeader className="text-center">
        ...
        <CardDescription>
          Set up your TraefikUI admin account
        </CardDescription>
      </CardHeader>
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <CardFooter className="flex flex-col gap-3">
          <Button type="submit" className="w-full" disabled={isSubmitting || registrationEnabled === null}>
